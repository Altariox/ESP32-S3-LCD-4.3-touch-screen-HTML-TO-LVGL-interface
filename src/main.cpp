...
// Generated UI from HTML/CSS/JS
extern "C" {
    #include "generated/ui_generated.h"
    
    // Function called from generated C code to send serial messages
...
void setup()
{
    ...
    // Initialize the generated UI from HTML/CSS/JS
    lv_obj_t* screen = lv_scr_act();
    ui_generated_init(screen);
    
    // Create on-screen keyboard for text inputs
    static lv_obj_t* kb = lv_keyboard_create(screen);
    lv_obj_add_flag(kb, LV_OBJ_FLAG_HIDDEN);
    lv_obj_set_size(kb, ESP_PANEL_LCD_H_RES, ESP_PANEL_LCD_V_RES / 2);
